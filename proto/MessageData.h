...
namespace trip
{
    namespace client
    {
        ...
        enum MessageType
        {
            ...
            RSP_Connect     = 0x8000 | REQ_Connect, 
            RSP_Ping        = 0x8000 | REQ_Ping,
            RSP_Disconnect  = 0x8000 | REQ_Disconnect,
            ...
            RSP_Bind        = 0x8000 | REQ_Bind,
            RSP_Meta        = 0x8000 | REQ_Meta,
            RSP_Map         = 0x8000 | REQ_Map,
            RSP_Data        = 0x8000 | REQ_Data,
            RSP_Unbind      = 0x8000 | REQ_Unbind,
            ...
            RSP_Register    = 0x8000 | REQ_Register, 
            RSP_Unregister  = 0x8000 | REQ_Unregister, 
            RSP_Find        = 0x8000 | REQ_Find, 
